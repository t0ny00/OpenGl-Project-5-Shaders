...
bool glShader::setTexture(GLcharARB* my_sample_name, GLuint my_texture_object, GLuint index ) {
	...
	int my_sampler_uniform_location = glGetUniformLocation(ProgramObject, my_sample_name);

	/*switch(my_sampler_uniform_location) {
		case -1:
			cout << "Error en el nombre de la variable o no se esta usando en el shader" << "\n";
			break;
		case 0:			
			break;
		default:
	...
	glUniform1i(my_sampler_uniform_location, index);
